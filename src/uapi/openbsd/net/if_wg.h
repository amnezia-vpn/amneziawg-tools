...
#define WG_INTERFACE_DEVICE_HAS_DI (1 << 21)
#define WG_INTERFACE_DEVICE_HAS_DR (1 << 22)
#define WG_INTERFACE_DEVICE_HAS_DC (1 << 23)
#define WG_INTERFACE_DEVICE_HAS_DT (1 << 24)
